...
export default function Main(props) {
  ...
  const dispatch=useDispatch();
   ...
   console.log("fcm",props.fcm)
   userreceived&&axios.post("fcm_token/",{fcm_token:props.fcm}).then(()=>{
  ...
  return (
      ...
      <Drawer.Navigator >
        ...
        <Drawer.Screen name="RecipeDetail" component={RecipeDetail}  options={{
    drawerItemStyle: { height: 0 }
  }}/>
       <Drawer.Screen name="FridgeDetail" component={FridgeDetail}  options={{
    drawerItemStyle: { height: 0 }
  }}/>
