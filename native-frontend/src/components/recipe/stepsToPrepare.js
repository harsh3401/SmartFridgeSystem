    ...
    <View>
      <View style={{marginTop:30, marginBottom:10}}>
        <Flex inline style={{height:40}}>
            ...
            <Text style={{fontSize:25,fontFamily:'sans-serif',textDecorationLine: 'underline', marginLeft:12,textShadowRadius: 5,textShadowColor: 'rgba(0, 0, 0, 0.75)',}}>Steps to prepare</Text>
        </Flex>
      </View>
      <FlatList 
            data = {stepstocook}
            renderItem = {step=>{
                return (
                    <Flex inline style={{minHeight:40, marginLeft:20, elevation:4}}>
                      <Octicons name="dot-fill" size={24} color="black" />
                      <Text style={{fontSize:20,color:'black', fontStyle:'italic', marginLeft:20,textShadowRadius: 10}}>{step.item}</Text>
                    </Flex>
                )
            }}
        />
