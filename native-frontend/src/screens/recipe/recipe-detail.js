...
const RecipeDetail = ({route}) => {
  ...
  return (
    <ScrollView style={{margin:15,marginTop:40}}>
      ...
      <View>
      <Text style={{fontSize:30, marginRight:20}}>{route.params.recipe_name}</Text>
      </View>
      ...
      <View style={{marginTop:20}}>
        ...
        <View style={{width:200,height:75}}>
          <ImageBackground style={{height:85}} source={{uri : "https://en.xn--icne-wqa.com/images/icones/7/1/oval-blue.png"}}>
              <Text style={{textAlign:'center', color:'white',fontSize:25,marginTop:20}}>{route.params.time_to_make}</Text>
          </ImageBackground>
        </View>
      </View>
      <View style={{marginTop:20}}>
